const name = "Roshan"
const num = 56
console.log(`My name is ${name} and my count is ${num}`);

const gameName = new String("NiggaMan")
console.log(gameName);
const yo = new String("Meow Meow Nigga")
console.log(yo);
console.log(yo.split(' ')); //splitting in form of an array
